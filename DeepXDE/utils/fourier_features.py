...
class FourierFeatureTransform(torch.nn.Module):
    ...
    def __init__(self, in_dim, num_features=256, sigma=10.0):
        ...
        # Create the random projection matrix B and register it as a buffer.
        # A buffer is part of the model's state but not considered a parameter
        # to be trained. It will be moved to the correct device (e.g., GPU)
